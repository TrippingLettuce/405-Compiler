...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_GREATERTHAN = 25,               /* GREATERTHAN  */
  YYSYMBOL_LESSTHAN = 26,                  /* LESSTHAN  */
  YYSYMBOL_ABS = 27,                       /* ABS  */
  YYSYMBOL_NOT = 28,                       /* NOT  */
  YYSYMBOL_AND = 29,                       /* AND  */
...
static const char *const yytname[] =
{
  ...
  "FLOAT", "CHAR", "RETURN", "RESULT", "WHILE", "IF", "ELSE", "COUNT",
  "IDENTIFIER", "SUM", "NUMBER", "WORD", "SEMICOLON", "EQUAL", "NOTEQUAL",
  "PLUS", "MINUS", "TIMES", "DIVIDE", "GREATERTHAN", "LESSTHAN", "ABS",
  "NOT", "AND", "COMMENT", "$accept", "Program", "DeclList", "StmtList",
  "Stmt", "Decl", "VarDecl", YY_NULLPTR
};
...
{
       1,     2,     9,    10,    11,     2,    14,    15,    16,    13,
       0,    12
};

static const yytype_int8 yycheck[] =
{
       3,     4,     4,    19,     0,     4,    18,    16,    18,     7,
      -1,     6
};
